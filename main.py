...
fipe_pesados = Fipe(tipo_veiculo=TipoVeiculo.PESADOS.value, time_out=300, log_erro=True)
fipe_pesados.executar_apis()
sleep(1200)  # 20 minutos

fipe_leves = Fipe(tipo_veiculo=TipoVeiculo.LEVES.value, time_out=300, log_erro=True)
